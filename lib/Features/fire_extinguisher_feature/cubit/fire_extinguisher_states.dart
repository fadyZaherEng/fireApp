...
abstract class   FireExtinguisherStates extends Equatable {
  @override
  List<Object?> get props => [];
}

class CertificateInitial extends FireExtinguisherStates {}

class CertificateLoading extends FireExtinguisherStates {}

// Service Provider Selection States
class ServiceProvidersLoaded extends FireExtinguisherStates {
...
class CertificateInstallationForm extends FireExtinguisherStates {
...
class CertificateRequestSubmitted extends FireExtinguisherStates {
...
class CertificateError extends FireExtinguisherStates {
  final String message;
...
// Branch States
class BranchesLoaded extends FireExtinguisherStates {
