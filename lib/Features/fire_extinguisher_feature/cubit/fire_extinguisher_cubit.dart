...
import 'fire_extinguisher_states.dart';

class FireExtinguisherCubit extends Cubit<FireExtinguisherStates> {
  final FireExtinguisherApiService _apiService;
  final Logger _logger = Logger();
  bool _isClosed = false;

  FireExtinguisherCubit(this._apiService) : super(CertificateInitial());

  // Safe emit helper method to prevent "Cannot emit new states after calling close" error
  void safeEmit(FireExtinguisherStates state) {
