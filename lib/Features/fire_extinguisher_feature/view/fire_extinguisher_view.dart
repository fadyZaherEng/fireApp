...
import '../data/services/fire_extinguisher_api_service.dart';
import 'widgets/certificate_installation_form.dart';
import 'widgets/success_dialog.dart';

class FireExtinguisherView extends StatefulWidget {
  const FireExtinguisherView({super.key});

  @override
  State<FireExtinguisherView> createState() =>
      _ServiceProviderSelectionViewState();
}

class _ServiceProviderSelectionViewState extends State<FireExtinguisherView> {
  final _formKey = GlobalKey<FormState>();
  final _areaController = TextEditingController();
  final _certificateApiService = FireExtinguisherApiService();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          localizations.translate('fire_extinguisher'),
          style: TextStyle(
            fontFamily: 'Almarai',
            fontSize: 18.sp,
            color: AppColors.primaryBlue,
