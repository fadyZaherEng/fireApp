...
import 'fire_prevention_maintenance_states.dart';

class FirePreventionMaintenanceCubit
    extends Cubit<FirePreventionMaintenanceStates> {
  final FirePreventionMaintenanceApiService _apiService;
  final Logger _logger = Logger();
  bool _isClosed = false;

  FirePreventionMaintenanceCubit(this._apiService)
      : super(CertificateInitial());

  // Safe emit helper method to prevent "Cannot emit new states after calling close" error
  void safeEmit(FirePreventionMaintenanceStates state) {
