...
abstract class FirePreventionMaintenanceStates extends Equatable {
  @override
  List<Object?> get props => [];
}

class CertificateInitial extends FirePreventionMaintenanceStates {}

class CertificateLoading extends FirePreventionMaintenanceStates {}

// Service Provider Selection States
class ServiceProvidersLoaded extends FirePreventionMaintenanceStates {
...
class CertificateInstallationForm extends FirePreventionMaintenanceStates {
...
class CertificateRequestSubmitted extends FirePreventionMaintenanceStates {
...
class CertificateError extends FirePreventionMaintenanceStates {
  final String message;
...
// Branch States
class BranchesLoaded extends FirePreventionMaintenanceStates {
