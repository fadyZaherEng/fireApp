...
import '../data/services/fire_prevention_maintenance_api_service.dart';
import 'widgets/certificate_installation_form.dart';
import 'widgets/success_dialog.dart';

class FirePreventionMaintenanceView extends StatefulWidget {
  const FirePreventionMaintenanceView({super.key});

  @override
  State<FirePreventionMaintenanceView> createState() =>
      _ServiceProviderSelectionViewState();
}

class _ServiceProviderSelectionViewState
    extends State<FirePreventionMaintenanceView> {
  final _formKey = GlobalKey<FormState>();
  final _areaController = TextEditingController();
  final _durationController = TextEditingController();
  final _certificateApiService = FirePreventionMaintenanceApiService();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          localizations.translate('fixcontract'),
          style: TextStyle(
            fontFamily: 'Almarai',
            fontSize: 18.sp,
            color: AppColors.primaryBlue,
      ...
      child: Column(
        ...
        children: [
          CertificateInstallationForm(
            ...
            onVisitsPerYearChanged: (visits) {
              setState(() {
                _visitsPerYear = visits;
              });
            },
