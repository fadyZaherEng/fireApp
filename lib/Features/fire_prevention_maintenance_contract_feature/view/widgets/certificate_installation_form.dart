...
class CertificateInstallationForm extends StatelessWidget {
  ...
  // New maintenance contract parameters
  final int visitsPerYear;
  final Function(int) onVisitsPerYearChanged;
  ...
  const CertificateInstallationForm({
    ...
    required this.onVisitsPerYearChanged,
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          // Duration in Months
          SectionTitle(title: localizations.translate('contractDuration')),
          SizedBox(height: 12.h),
          DurationInput(
          ...
          // Visits Per Year
          SectionTitle(title: localizations.translate('visitsPerYear')),
          SizedBox(height: 12.h),
          VisitsPerYearSelector(
            selectedVisits: visitsPerYear,
            onVisitsChanged: onVisitsPerYearChanged,
            localizations: localizations,
          ),
          SizedBox(height: 20.h),
