...
import 'engineering_inspection_report_states.dart';

class EngineeringInspectionReportCubit
    extends Cubit<EngineeringInspectionReportStates> {
  final EngineeringInspectionReportApiService _apiService;
  final Logger _logger = Logger();
  bool _isClosed = false;

  EngineeringInspectionReportCubit(this._apiService)
      : super(CertificateInitial());

  // Safe emit helper method to prevent "Cannot emit new states after calling close" error
  void safeEmit(EngineeringInspectionReportStates state) {
