...
class _ContractScreenState extends State<ContractScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<String>> rows = [
      ...
      // [t.translate("empty"), '200 ${t.translate("currency")}', t.translate("empty")],
    ];
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 5,
                      child: _buildInfoRow(
                          AppLocalizations.of(context).translate('visit_value'),
                          '500'),
                    ),
                  ],
                ),
                  ...
                  child: Row(
                    children: [
                      ...
                      DataTable(
                        ...
                        columns: [
                          DataColumn(
                            label: Center(child: Text(t.translate("itemName"))),
                          ),
                          DataColumn(
                            label: Center(
                              child: Text(
                  ...
                  children: rowsinfo.map((row) {
                    return TableRow(
                      children: List.generate(row.length, (index) {
                        ...
                        return Container(
                          color: isSideTitle ? Colors.blue[900] : Colors.white,
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              color:
                                  isSideTitle ? Colors.white : Colors.blue[900],
